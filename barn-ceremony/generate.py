...
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Great+Vibes&family=Cormorant+Garamond:wght@400;500&display=swap">
<style>
/* One committed visual world: a warm, dark room. Painted explicitly so the
   page holds on either host ground rather than borrowing the viewer's theme. */
:root { --ground: #0a0705; --ink: #c9b189; }
